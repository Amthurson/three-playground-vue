  ...
  export default  defineComponent({
    ...
    setup() {
      ...
      const init = () => {
          ...
          camera.position.x = 13.254520279638944;
          camera.position.y = 1.7;
          camera.position.z = 12.82802906582076;
        ...
        let controls = new FirstPersonControls( camera, containerRef.value );
        controls.activeLook = false; // Whether or not it's possible to look around. Default is true.
				controls.mouseDragOn = true; // Whether or not it's possible to look around. Default is true.
        ...
        //   click();
          ...
          // 渲染结果 ------------------------------------------------------------------------------------
          function animate() {
            controls.update( state.clock.getDelta() );
